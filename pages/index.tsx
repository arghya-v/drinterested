       ...
       <header className="bg-[#2C3E4F] text-white py-20 px-4">
         <div className="max-w-4xl mx-auto text-center">
           ...
           <p className="text-lg md:text-xl text-[#D1E7F0]">
             Discover your pathway to a career in healthcare with Dr.Interested. From engaging webinars to hands-on research opportunities, we are here to help high school students explore the world of medicine.
           </p>
         </div>
       </header>
         ...
         <div className="max-w-4xl w-full flex flex-col md:flex-row items-start md:justify-between gap-8">
           ...
           <div className="md:w-1/2">
             ...
             <p className="text-lg text-[#4A4A4A] md:text-right">
               We are dedicated to providing high school students with the tools and resources they need to succeed in the medical field. 
